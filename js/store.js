...
function store() {
    this.products = [
        new product("APL", "Chana Jor Garam", "Simple spicy and tangy snack chaat.", 12, 90, 0, 2, 0, 1, 2),
        new product("AVC", "Chola aloo tikki", "Spiced potato which are stuffed with various fillings.", 16, 90, 0, 1, 1, 1, 2),
        new product("BAN", "Tawa paneer masala", "combination of paneer/cottage cheese, capsicum, onion,etc.", 4, 120, 0, 2, 1, 2, 2),
